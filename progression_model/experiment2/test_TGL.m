function [final_performance, final_performance_t,arr_wR_TGL] = test_TGL()
...
addpath('../../MALSAR/functions/progression_model/TGL/');
...
load_data  = csvread('./data_ADAS.csv',1);
...
% [ best_param, perform_mat,best_params] = progressModelCrossValidation1Param...
%     ( X_tr, Y_tr, 'Least_TGL', opts, param_range, cv_fold, eval_func_str, higher_better);
...
W = Least_TGL(X_tr, Y_tr, best_params(1,1),best_params(2,1),best_params(3,1), opts);

% show final performance
%eval_func = str2func(eval_func_str);
[final_performance, final_performance_t]= eval_MTL_nmse_progress(Y_te, X_te, W); 
arr_wR_TGL = eval_MTL_wR(Y_te, X_te, W);
