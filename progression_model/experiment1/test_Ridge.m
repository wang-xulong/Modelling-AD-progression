function [final_performance, final_performance_t,arr_wR_Ridge ] = test_Ridge ()
 

%clear; clc;
%clear all;
addpath('../../MALSAR/functions/Ridge/');
...
[ best_param, perform_mat] = CrossValidation1Param...
    ( X_tr, Y_tr, 'Least_Ridge', opts, param_range, cv_fold, eval_func_str, higher_better);
% [ best_param, perform_mat] = CrossValidation1Param...
